...
public class FarmRecord extends UpdatableRecordImpl<FarmRecord>
  ...
  private static final long serialVersionUID = 487298152;
  ...
  @Override
  public FarmRecord value4(OffsetDateTime value) {
    setCreatedAt(value);
    return this;
  }

  @Override
  public FarmRecord value5(OffsetDateTime value) {
    setUpdatedAt(value);
    return this;
  }
  ...
  public FarmRecord(
      UUID id, String name, String note, OffsetDateTime createdAt, OffsetDateTime updatedAt) {
    super(Farm.FARM);
