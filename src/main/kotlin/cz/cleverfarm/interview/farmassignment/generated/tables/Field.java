...
public class Field extends TableImpl<FieldRecord> {
    ...
    private static final long serialVersionUID = 2069569339;
     ...
     */
    public final TableField<FieldRecord, UUID> ID = createField(DSL.name("id"), org.jooq.impl.SQLDataType.UUID.nullable(false), this, "");

    /**
     * The column <code>public.field.name</code>.
     */
    public final TableField<FieldRecord, String> NAME = createField(DSL.name("name"), org.jooq.impl.SQLDataType.VARCHAR(255).nullable(false), this, "");

    /**
     * The column <code>public.field.farm_id</code>.
     */
    public final TableField<FieldRecord, UUID> FARM_ID = createField(DSL.name("farm_id"), org.jooq.impl.SQLDataType.UUID.nullable(false), this, "");
