...
public class FieldRecord extends UpdatableRecordImpl<FieldRecord>
    implements Record5<UUID, String, UUID, OffsetDateTime, OffsetDateTime> {

  private static final long serialVersionUID = -1944013209;
  ...
  @Override
  public Row5<UUID, String, UUID, OffsetDateTime, OffsetDateTime> valuesRow() {
  ...
  public FieldRecord values(
      UUID value1, String value2, UUID value3, OffsetDateTime value4, OffsetDateTime value5) {
    value1(value1);
    value2(value2);
    value3(value3);
    value4(value4);
  ...
  public FieldRecord(
      UUID id, String name, UUID farmId, OffsetDateTime createdAt, OffsetDateTime updatedAt) {
    super(Field.FIELD);
