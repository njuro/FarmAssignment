...
values ('8e6e3b02-3673-4600-92d6-6465ae2bf816', 'Sample Farm 1', 'Some note')
ON CONFLICT DO NOTHING;

insert into farm (id, name, note)
values ('15a7d4e9-364e-48d5-8c6a-e471c4d68f38', 'Sample Farm 2', NULL)
ON CONFLICT DO NOTHING;

insert into farm (id, name, note)
values ('20e45791-d423-4d44-8018-a0060e085d35', 'Sample Farm 3', 'This farm starts as empty')
ON CONFLICT DO NOTHING;
